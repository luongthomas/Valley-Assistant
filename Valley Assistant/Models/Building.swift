...
enum BuildingName: String, Codable {
    case generalStore, carpentersShop, medicalClinic, blacksmith, jojamart, theStardropSaloon, oneRiverRoad, trailer, mayorsManor, oneWillowLane, twoWillowLane, elliotsCabin
}
